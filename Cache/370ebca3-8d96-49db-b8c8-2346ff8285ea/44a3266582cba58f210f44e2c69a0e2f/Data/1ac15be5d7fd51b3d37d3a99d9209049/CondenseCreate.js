...
let FolderBox = (() => {
    ...
    var FolderBox = _classThis = class extends _classSuper {
        constructor() {
            super();
        ...
        expand() {
            ...
            this.childBox.getTransform().setWorldPosition(new vec3(myPos.x + this.childOffsetX, myPos.y + this.childOffsetY, myPos.z + this.childOffsetZ));
            this.childBox.getTransform().setWorldRotation(myTransform.getWorldRotation());
            this.childBox.getTransform().setLocalScale(new vec3(1, 1, 1));
            this.isOpen = true;
            print("Expanded: " + this.getSceneObject().name + " created " + this.childBox.name);
        }
        condense() {
            if (this.childBox) {
                print("Condensed: deleting " + this.childBox.name);
    ...
    __setFunctionName(_classThis, "FolderBox");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        FolderBox = _classThis = _classDescriptor.value;
