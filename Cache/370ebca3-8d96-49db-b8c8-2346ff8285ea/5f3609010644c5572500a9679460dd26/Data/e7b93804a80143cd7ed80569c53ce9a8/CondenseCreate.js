...
let CondenseCreate = (() => {
    ...
    var CondenseCreate = _classThis = class extends _classSuper {
        ...
        readNodeIdFromName() {
            ...
            // New safe format: TreeNode__frontend_file_one__3
            ...
            // Old fallback format: TreeNode_frontend_3
        ...
        openFolder() {
            ...
            for (var i = 0; i < count; i++) {
                ...
                // Safe name format. Works even when IDs contain underscores.
                ...
                print("Created child: " + childNode.label + " nodeId=" + childId);
            }
        }
        closeFolder() {
        ...
        setLabelOnBox(box, label) {
            ...
            // No warning spam. If there is no NodeLabel, the tree still works.
            if (!labelObject) {
                return;
            }
