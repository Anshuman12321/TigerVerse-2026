    ...
    var TreeManager = _classThis = class extends _classSuper {
        ...
        buildTree() {
            ...
            if (this.data.children && this.data.children.length > 0) {
                this.createChildrenRecursive(this.data.children, this.rootBox, this.data.id, 1, 0);
            }
        }
        createChildrenRecursive(children, parentObject, parentPath, depth, centerX) {
            ...
            for (var i = 0; i < count; i++) {
                ...
                if (child.children && child.children.length > 0) {
                    this.createChildrenRecursive(child.children, box, childPath, depth + 1, x);
                }
            }
        }
        setLabel(obj, label) {
